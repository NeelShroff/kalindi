...
const milestones = [
  { year: "2021", title: "The Beginning", desc: "Kalindi was born with a vision of trust and quality, selling pure almonds door-to-door." },
  { year: "2023", title: "Digital Leap", desc: "Launched online, reaching our first 50+ customers and introducing the iconic Royal Gift Box collection." },
  { year: "2026", title: "Legacy of Trust", desc: "100+ families trust Kalindi today. FSSAI certified and loved by nutritionists across India." },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <div className="flex gap-8">
              <div>
                <p className="text-3xl font-bold bg-gradient-to-r from-orange-600 to-amber-700 bg-clip-text text-transparent">5+</p>
